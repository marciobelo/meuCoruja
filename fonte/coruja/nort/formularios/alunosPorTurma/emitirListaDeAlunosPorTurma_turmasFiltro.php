...
<form id="cadastro" name="cadastro" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>?acao=buscarTurmasFiltro" >
    <fieldset>
        <legend>Lista de Alunos por Turma</legend><br>
                ...
                <td>
                    <select name="idPeriodoLetivo" onChange="document.cadastro.submit()" <?php echo $estaDesabilitadoPeriodo ?> >
                        ...
                        foreach ($arrayPeriodoLetivo as $periodoLetivo) {
                            $selected = $periodoLetivo->getIdPeriodoLetivo() == $idPeriodoLetivo ? 'selected' : '';
            ...
            <tr>
                ...
                <td>
                    <select name="siglaDisciplina" <?php echo $estaDesabilitado ?> >
                        ...
                        <?php
                        foreach ($arraySiglaNomeDisciplina as $siglaDisciplinaKey => $nomeDisciplina) 
                        {
                            $selected = ($siglaDisciplinaKey === $siglaDisciplina) ? 'selected' : '';
                            echo '<option ' . $selected . ' value="' . $siglaDisciplinaKey . '" >' . $siglaDisciplinaKey . ' - ' . $nomeDisciplina . '</option>';
                        }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="idPessoaProfessor" <?php echo $estaDesabilitado ?> >
                        ...
                        {
                            $selected = ($idPessoa == $idPessoaProfessor) ? 'selected' : '';
