...
class EmitirProtocoloComGradeHorariaPDF extends FpdfSiro {
    ...
    function EmitirProtocoloComGradeHorariaPDF($listaHorarioDasAulas,$listaDisciplinaSegunda,$listaDisciplinaTerca,
    ...
    function gerarCabecalho() {
        ...
        $txt="Grade Horária com as Inscrições Solicitadas ".$this->identificao;
    ...
    function desenharResultado() {
        ...
        $txt= "\nATENÇÃO: O Aluno deve estar ciente que a grade acima são apenas solicitações, que poderão ser deferidas ou não pelo Coordenador Acadêmico, e que o resultado será publicado e noticiado no tempo devido.";
        $this->MultiCell($tamHorizontalDoCabecalho,4.5,$txt, $this->debug,'L');
...
if($_POST){
    ...
    $pdf = new EmitirProtocoloComGradeHorariaPDF($listaHorarioDasAulas,$listaDisciplinaSegunda,$listaDisciplinaTerca,
            $listaDisciplinaQuarta,$listaDisciplinaQuinta,$listaDisciplinaSexta,$listaDisciplinaSabado, $identificao, $listaHorarioDasAulasSabado);
