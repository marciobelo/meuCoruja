<script>
    function cancelar(){
        window.location.href = 'SolicitarInscricaoEmTurmas_controle.php?action=listar';
    }
</script>

<form name="listaInscricao" method="POST" action="SolicitarInscricaoEmTurmas_controle.php?action=inserir">
    ...
    <table class="table_lista" width="100%" align=CENTER id="Lista">
        <caption class="cabecalho">
           Voc&#234; solicitou inscri&#231;&#227;o para seguinte turma:
        </caption>
...
<?php
   ...
   echo"<table border='0' align='center'>";
      echo"<tr>";
       echo"<td><input class='confirmar' name='solicitarInscricao' type='submit' value='Confirmar Solicita&#231;&#227;o' /></td>";
       echo"<td><input class='cancelar' name='cancelarInscricao' type='button'".
           " value='Cancelar Solicita&#231;&#227;o' onclick='cancelar();'/></td>";
      echo"</tr>";
    echo"</table>";
   ?>
    <br />
