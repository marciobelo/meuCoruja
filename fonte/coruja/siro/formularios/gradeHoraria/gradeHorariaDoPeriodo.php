...
$linha=NULL;
$situacaoInscricao="DEF','CUR";

//MONTAR GRADE DOS 5 DIAS
$grade= "<table class='table_lista' name='gradeManha' align='center' width=80%' id='grade'>";
$grade.="<caption align='top' class='cabecalho'>".
        "Grade Hor&aacute;ria com as Disciplinas do Período Letivo Vigente".
        "</caption> ";
...
$semana=   "<tr class='tr_cabecalho_grade'> ".
        ...
        "<td width=17%><div align='center'>Ter&#231;a</div></td>".
...
$sabado="<tr class='tr_cabecalho_grade'> ".
        "<td width=130px><div align='center'>Hor&aacute;rios das Aulas</div></td> ".
        "<td width=40%><div align='center'>S&aacute;bado</div></td> ".
        "</tr> ";
...
foreach($temposSemanais as $tempo) {
    ...
    if($tempo->getDiaSemana()=='SEG') {
        ...
        $turmasTempo = TempoSemanal::obterTurmasByTempoSemanal($matriculaAluno->getMatriculaAluno(),$situacaoInscricao, $tempo->getIdTempoSemanal( ),$periodoLetivo->getIdPeriodoLetivo());
