...
<fieldset id="coruja">
    <legend>Incluir Espa&ccedil;o</legend>
    <input type="hidden" name="idEspaco" value="" />
    <table width="646">
        <tr>
            <td width="137"><b>Nome : </b> </td>
            <td width="499"><input type="text" name="nome" value="<?php echo $_POST['nome'];?>" maxlength="45" size="40"/></td>
        </tr>
        <tr>
            <td width="137"><b>Capacidade : </b> </td>
            <td idth="499"><input type="text" name="capacidade" value="<?php echo $_POST['capacidade'];?>" maxlength="3" size="3" onkeypress="return Mascaras_Format(document.formEspaco,'capacidade','9999999999999999999',event);"/></td>
        </tr>
        <tr>
            <td colspan="2">
