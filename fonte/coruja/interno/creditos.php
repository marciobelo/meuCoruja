        ...
        <div id="conteudo">
            <form name="credito">
                <fieldset id="fieldsetGeral">
                    <legend>Sistema Coruja</legend>
                    <table cellspacing="2" cellpadding="2">
                        <tr>
                            <td>
                                <img alt="" src='/coruja/imagens/mbelo.jpg' title='Marcio Belo' />
                            </td>
                            <td>
                                <font> <b>Prof. Marcio Belo:</b></font>
                                Analista responsável pela especificação e integridade concentual do projeto. Mantém o repositório de versionamento dos artefatos.
                                <br/>
                                Contato: mbelo.br [em] gmail.com
                            </td>
                        </tr>
