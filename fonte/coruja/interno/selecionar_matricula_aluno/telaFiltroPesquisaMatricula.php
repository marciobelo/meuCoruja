...
<form id="cadastro" method="GET" name="cadastro" action="/coruja/interno/selecionar_matricula_aluno/selecionarMatricula_controle.php" >
    ...
    <fieldset id="fieldsetGeral">
        ...
        <legend><?php echo $controleDestinoTitulo; ?><br/>
            Busca de Matr&iacute;cula do Curso <?php echo $siglaCurso; ?></legend>
